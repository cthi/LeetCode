class Solution(object):
    ...
    def buildTreeHelper(self, preorder, inorder, p_s, p_e, i_s, i_e):
        ...
        node.left = self.buildTreeHelper(preorder, inorder, middleIndexP + 1, middleIndexP + len, i_s, middleIndexI - 1)
        node.right = self.buildTreeHelper(preorder, inorder, p_s + len + 1, p_e, middleIndexI + 1, i_e)
