class Solution(object):
    ...
    def canCrossHelper(self, curStone, lastJump, goal, stones, memo):
        if curStone == goal:
            ...
            res = self.canCrossHelper(curStone + lastJump + 1, lastJump + 1, goal, stones, memo)
            res = res or self.canCrossHelper(curStone + lastJump, lastJump, goal, stones, memo)
            if lastJump != 1:
                res = res or self.canCrossHelper(curStone + lastJump - 1, lastJump - 1, goal, stones, memo)
